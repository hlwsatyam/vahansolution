            ...
            <div className="flex justify-center  ">
              <img width={'80%'} src={mlogo} />
               ...
               <div style={{ marginTop: "-8px", marginBottom: "18px" }}  className="flex justify-center  ">
                  <Text    className="text-[12px] text-center mt-2 font-extrabold">{data?.data?.rc_data?.document_id || data?.data?.rc_number   }</Text>
               </div>
...
<div className="flex justify-center">
 ...
 <InfoRow
                label="Name"
                value={data?.data?.rc_data?.owner_data?.name || data?.data?.owner_name
  }
                isBlue={true}
              />
              <InfoRow
                label="Son / Daughter / Wife of"
                value={data?.data?.rc_data?.owner_data?.father_name  || data?.data?.father_name  }
                isBlue={true}
              />
   ...
   data?.data?.vehicle_chasi_number)
...
||    data?.data?.vehicle_chasi_number
   ...
   data?.data?.vehicle_engine_number)
                ...
                && (
                  <InfoRow
                    label="Engine No."
                    value={data?.data?.rc_data?.vehicle_data
                      ?.engine_number    || 
   ...
   data?.data?.vehicle_category_description)
  ...
  || 
   ...
   data?.data?.vehicle_gross_weight
)
 ...
 || 
   ...
   data?.data?.insurance_policy_number)
